function renderNavBar(){
	...
	<div id="nav-bar" class="bg-info">
		<div class="option" id="go_to_new_reports_page">
		...
		<div class="option" id="go_to_reports_page">
		...
		<div class="option" id="go_to_settings_page">
	...
	`
	document.write(t)
	document.getElementById('go_to_new_reports_page').onclick = function(){
		window.location.replace('../new_report/index.html')
	}
	
	document.getElementById('go_to_settings_page').onclick = function(){
		window.location.replace('../settings/index.html')
	}
	document.getElementById('go_to_reports_page').onclick = function(){
