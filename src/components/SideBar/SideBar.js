		...
		return(
			<div id="SideBar">
				...
				<div active={this.state.activeOption === "new_report"?"active":undefined} className="option first-option" id="go_to_new_reports_page" onClick={this.optionClickHandler1}>
					...
					<h1 className="title">گزارش جدید</h1>
				</div>
				
				<div active={this.state.activeOption === "reports"?"active":undefined} className="option" id="go_to_reports_page" onClick={this.optionClickHandler2}>
					...
					<h1 className="title">گزارش ها</h1>
				</div>
				
				<div active={this.state.activeOption === "settings"?"active":undefined} className="option" id="go_to_settings_page" onClick={this.optionClickHandler3}>
					<svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-gear" fill="white" xmlns="http://www.w3.org/2000/svg">
