...
function SideBar(props){
	...
	<div id="SideBar" className="bg-info">
		<div className="option" id="go_to_new_reports_page" onClick={()=>{window.location.assign('#/new_report')}}>
			...
			<b className="title">new report</b>
		</div>
		
		<div className="option" id="go_to_reports_page" onClick={()=>window.location.assign('#/reports')}>
		...
		<div className="option" id="go_to_settings_page" onClick={()=>window.location.assign('#/settings')}>
